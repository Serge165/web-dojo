...
const DIVIDERS = [
  ...
  { id: "peaks", label: "Peaks", paths: [{ d: "M0,120 L0,60 L150,20 L300,60 L450,20 L600,60 L750,20 L900,60 L1050,20 L1200,60 L1200,120 Z" }] },
  { id: "mountains", label: "Mountains", paths: [
    { d: "M0,120 L0,90 L300,40 L600,90 L900,40 L1200,90 L1200,120 Z", opacity: 0.45 },
    { d: "M0,120 L0,80 L200,30 L450,80 L700,25 L950,75 L1200,35 L1200,120 Z" },
  ] },
  { id: "clouds", label: "Clouds", paths: [{ d: "M0,120 L0,70 Q75,40 150,70 Q225,100 300,70 Q375,40 450,70 Q525,100 600,70 Q675,40 750,70 Q825,100 900,70 Q975,40 1050,70 Q1125,100 1200,70 L1200,120 Z" }] },
  { id: "steps", label: "Steps", paths: [{ d: "M0,120 L0,90 L200,90 L200,60 L400,60 L400,30 L600,30 L600,60 L800,60 L800,90 L1000,90 L1000,60 L1200,60 L1200,120 Z" }] },
  { id: "drip", label: "Drip", paths: [{ d: "M0,0 L1200,0 L1200,40 C1100,40 1100,95 1000,95 C900,95 900,40 800,40 C700,40 700,80 600,80 C500,80 500,40 400,40 C300,40 300,100 200,100 C100,100 100,40 0,40 Z" }] },
];
